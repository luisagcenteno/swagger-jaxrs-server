...
public class ContactsApi  {
   ...
   public ContactsApi(@Context ServletConfig servletContext) {
    ...
    @io.swagger.annotations.ApiOperation(value = "", notes = "", response = InlineResponse200.class, responseContainer = "List", tags={ "Contact", })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK", response = InlineResponse200.class, responseContainer = "List") })
